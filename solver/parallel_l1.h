...
namespace alsm
{
	template <DeviceType D, typename T> class parallel_l1
	{
	private:
	...
	private:
		...
		T* output_e;
	public:
		parallel_l1(std::array<stream<D>, 3> three_stream, int in_b_dimension, int in_x_dimension, int in_max_iter, int in_wait_ms)
