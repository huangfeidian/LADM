...
namespace alsm
{
	template <DeviceType D, typename T> class seq_l1
	{
	private:
		//in seq solver these atomics are not used , we need them because the constructors of alsm_server and alsm_client
